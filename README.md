Here’s the updated version with "BioEngine" replaced by "Biocraft":

---

# Biocraft - A Bio Generator
...
Ever struggled with coming up with a memorable Twitter (now X) bio? Then you're at the right stop! Introducing Biocraft, an AI-Powered Twitter Bio Generator that is easy to use. Built with Nextjs, Shadcn UI, TypeScript and Groq LLMs Provider.

## Built With

Biocraft is built with:
