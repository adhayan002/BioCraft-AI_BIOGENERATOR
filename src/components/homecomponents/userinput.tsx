...
const UserInput = () => {
  ...
  return (
    <div className="relative flex flex-col items-start gap-4 slg:gap-8">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          className="grid w-full items-start gap-6"
        >
          <fieldset className="grid gap-3 slg:gap-6 rounded-[8px] border p-4 bg-background/10 backdrop-blur-sm">
